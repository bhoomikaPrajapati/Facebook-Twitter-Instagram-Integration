...
public class InstagramLoginActivity extends Activity implements OnClickListener {
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			if (msg.what == InstagramApp.WHAT_FINALIZE) {
				...
				Toast.makeText(InstagramLoginActivity.this, "Check your network.",
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mApp.setListener(new InstagramApp.OAuthAuthenticationListener() {
			...
			public void onFail(String error) {
				Toast.makeText(InstagramLoginActivity.this, error, Toast.LENGTH_SHORT)
						.show();
			}
		});
		setWidgetReference();
	...
	public void onClick(View v) {
		if (v == btnConnect) {
			...
			startActivity(new Intent(InstagramLoginActivity.this, AllMediaFiles.class)
			...
			startActivity(new Intent(InstagramLoginActivity.this, Relationship.class)
	...
	/*	new ImageLoader(InstagramLoginActivity.this).DisplayImage(
				userInfoHashmap.get(InstagramApp.TAG_PROFILE_PICTURE),
				ivProfile);*/
		ImageUtils.displayImage(InstagramLoginActivity.this,userInfoHashmap.get(InstagramApp.TAG_PROFILE_PICTURE),
				ivProfile);
